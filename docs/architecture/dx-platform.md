...
- [dx-cli/README.md](../dx-cli/README.md) - Full CLI documentation
- [dx-service-spec.md](./dx-service-spec.md) - service.yaml reference
- [../dx-cli/dx.config.yml](../dx-cli/dx.config.yml) - Configuration reference
- [AGENTS.md](../AGENTS.md) - Engineering guidelines (includes DX section)
