/**
 * White King SVG Component
 * app/features/theme/components/pieces/WhiteKing.tsx
 */
...
export const WhiteKing: React.FC<PieceSvgProps> = ({ size, color = '#FFFFFF', opacity = 1 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 45 45" opacity={opacity}>
      ...
      />
      {/* Center dot */}
      <Circle cx="22.5" cy="8" r="1.5" fill="#000" />
    </Svg>
  );
};
