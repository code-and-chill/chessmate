/**
 * White Queen SVG Component
 * app/features/theme/components/pieces/WhiteQueen.tsx
 */
...
export const WhiteQueen: React.FC<PieceSvgProps> = ({ size, color = '#FFFFFF', opacity = 1 }) => {
  return (
