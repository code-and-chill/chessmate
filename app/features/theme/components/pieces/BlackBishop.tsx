/**
 * Black Bishop SVG Component
 * app/features/theme/components/pieces/BlackBishop.tsx
 */
...
export const BlackBishop: React.FC<PieceSvgProps> = ({ size, color = '#000000', opacity = 1 }) => {
  return (
