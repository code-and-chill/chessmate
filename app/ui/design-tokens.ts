 ...
 * ============================================================================
 * 
 * ShadCN-Inspired, AI-Aesthetic Mobile UI Framework for React Native (Expo)
 * 
 * Structure:
 * - Design Tokens (Colors, Typography, Spacing, Radius, Shadows, Motion)
 * - Primitive Components (Box, Text, Button, Card, Panel, etc.)
 * - Chess-Specific Components (MatchCard, ScoreInput, PlayerRow, etc.)
 * - Theme System (Light/Dark mode with runtime switching)
 * - Utilities and Hooks
 * 
 * ============================================================================
 */
...
const getColor = (token: ColorToken | string, isDark: boolean): string => {
...
export const colorTokens = {
  ...
  // Secondary Accent – Nordic Purple
  purple: {
...
export const textVariants = {
  heading: { fontSize: typographyTokens.fontSize['3xl'], fontWeight: typographyTokens.fontWeight.bold },
  subheading: { fontSize: typographyTokens.fontSize.xl, fontWeight: typographyTokens.fontWeight.semibold },
  title: { fontSize: typographyTokens.fontSize.lg, fontWeight: typographyTokens.fontWeight.semibold },
  body: { fontSize: typographyTokens.fontSize.base, fontWeight: typographyTokens.fontWeight.normal },
  caption: { fontSize: typographyTokens.fontSize.sm, fontWeight: typographyTokens.fontWeight.normal },
  label: { fontSize: typographyTokens.fontSize.sm, fontWeight: typographyTokens.fontWeight.semibold },
  hint: { fontSize: typographyTokens.fontSize.xs, fontWeight: typographyTokens.fontWeight.normal },
};
...
// --- SHADOW TOKENS (AI-Aesthetic: Very Soft & Diffused) ---
