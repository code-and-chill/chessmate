 ...
 * Learn Tab - Main Hub
 * 
 * Entry point for learning features. Displays feature cards that navigate
 * to dedicated screens for lessons, tactics, game review, and openings.
 * 
 * Navigation flow:
 * - Interactive Lessons → /learning (lesson list)
 * - Tactics Trainer → /learning/tactics
 * - Game Review → /learning/review
 * - Openings Explorer → /learning/openings
 */
